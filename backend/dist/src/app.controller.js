...
let AppController = class AppController {
    ...
    adminLogin(body) {
        ...
        throw new common_1.UnauthorizedException('Notogri login yoki parol');
    }
    getConsultations(auth) {
        if (auth !== 'Bearer fake-jwt-token-123') {
            throw new common_1.UnauthorizedException('Ruxsat etilmagan');
        }
...
], AppController.prototype, "scheduleConsultation", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AppController.prototype, "getConsultations", null);
